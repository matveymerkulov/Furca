...
const enterStringField = element("string") as HTMLInputElement
const stringOk = element("string_ok") as HTMLButtonElement
const stringCancel = element("string_cancel") as HTMLButtonElement

export function enterString(caption, defaultValue, okFunc, cancelFunc = undefined) {
    setKeyBlock(true)
...
export function confirm(caption, yesFunc, noFunc = undefined) {
