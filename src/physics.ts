...
export class Vector {
    ...
    addToSprite(sprite: Sprite, k = 1) {
        sprite.setPosition(k * (sprite.x + this.x), k * (sprite.y + this.y))
    }

    subtractFromSprite(sprite: Sprite, k = 1) {
        sprite.setPosition(k * (sprite.x - this.x), k * (sprite.y - this.y))
    }
...
export function circleFromCircleVector(circle: Box, fromCircle: Box) {
...
export function circleFromBoxVector(circle: Box, fromBox: Box) {
...
export function circleFromPillVector(circle: Box, fromPill: Box) {
...
export function boxFromBoxVector(box: Box, fromBox: Box) {
...
export function pillFromBoxVector(box: Box, fromPill: Box) {
...
export function pillFromPillVector(pill: Box, fromPill: Box) {
