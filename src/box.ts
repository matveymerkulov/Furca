...
export class Box extends Point {
    ...
    static fromArea(left: number, top: number, width: number, height: number) {
    ...
    alterSize(dWidth: number, dHeight: number) {
        this.width += dWidth
        this.height += dHeight
    }
    ...
    drawDashedRegion(isCircle: boolean = false) {
...
export const serviceSprite1 = new Box()
export const serviceSprite2 = new Box()