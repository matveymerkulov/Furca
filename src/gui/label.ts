...
import {Align, defaultFontSize, Loc, setFontSize} from "../system.js"
...
export class Label extends Box {
    ...
    constructor(sprite: Box, public items: any[], public fontSize: number = defaultFontSize
                , public horizontalAlign: number = Align.center, public verticalAlign: number = Align.center
                , public format: string = "", public image: Img = undefined, public sizeMul = 1) {
